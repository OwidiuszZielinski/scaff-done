...
This is probably caused by illegal octal escape sequences.`),{_$litType$:o,strings:e,values:t}),f=dn(Ns),Te=dn(xt),be=Symbol.for("lit-noChange"),C=Symbol.for("lit-nothing"),bi=new WeakMap,fe=ye.createTreeWalker(ye,129,null,!1);let _e=Ot;function cn(o,e){if(!Array.isArray(o)||!o.hasOwnProperty("raw")){let t="invalid template strings array";throw t=`
        ...
        `.trim().replace(/\n */g,`
`),new Error(t)}return pi!==void 0?pi.createHTML(e):e}const Os=(o,e)=>{const t=o.length-1,i=[];let n=e===xt?"<svg>":"",s,r=ze;for(let a=0;a<t;a++){const d=o[a];let c=-1,m,u=0,v;for(;u<d.length&&(r.lastIndex=u,v=r.exec(d),v!==null);)if(u=r.lastIndex,r===ze){if(v[mi]==="!--")r=vi;else if(v[mi]!==void 0)r=fi;else if(v[to]!==void 0)ln.test(v[to])&&(s=new RegExp(`</${v[to]}`,"g")),r=me;else if(v[ks]!==void 0)throw new Error("Bindings in tag names are not supported. Please use static templates instead. See https://lit.dev/docs/templates/expressions/#static-expressions")}else r===me?v[$s]===">"?(r=s??ze,c=-1):v[gi]===void 0?c=-2:(c=r.lastIndex-v[Ts].length,m=v[gi],r=v[yi]===void 0?me:v[yi]==='"'?io:oo):r===io||r===oo?r=me:r===vi||r===fi?r=ze:(r=me,s=void 0);console.assert(c===-1||r===me||r===oo||r===io,"unexpected parse state B");const se=r===me&&o[a+1].startsWith("/>")?" ":"";n+=r===ze?d+Es:c>=0?(i.push(m),d.slice(0,c)+xo+d.slice(c)+ie+se):d+ie+(c===-2?(i.push(void 0),a):se)}const l=n+(o[t]||"<?>")+(e===xt?"</svg>":"");return[cn(o,l),i]};class Ge{constructor({strings:e,["_$litType$"]:t},i){this.parts=[];let n,s=0,r=0;const l=e.length-1,a=this.parts,[d,c]=Os(e,t);if(this.el=Ge.createElement(d,i),fe.currentNode=this.el.content,t===xt){const m=this.el.content,u=m.firstChild;u.remove(),m.append(...u.childNodes)}for(;(n=fe.nextNode())!==null&&a.length<l;){if(n.nodeType===1){{const m=n.localName;if(/^(?:textarea|template)$/i.test(m)&&n.innerHTML.includes(ie)){const u=`Expressions are not supported inside \`${m}\` elements. See https://lit.dev/msg/expression-in-${m} for more information.`;if(m==="template")throw new Error(u);St("",u)}}if(n.hasAttributes()){const m=[];for(const u of n.getAttributeNames())if(u.endsWith(xo)||u.startsWith(ie)){const v=c[r++];if(m.push(u),v!==void 0){const re=n.getAttribute(v.toLowerCase()+xo).split(ie),te=/([.?@])?(.*)/.exec(v);a.push({type:Po,index:s,name:te[2],strings:re,ctor:te[1]==="."?Ms:te[1]==="?"?Ds:te[1]==="@"?zs:Lt})}else a.push({type:Ao,index:s})}for(const u of m)n.removeAttribute(u)}if(ln.test(n.tagName)){const m=n.textContent.split(ie),u=m.length-1;if(u>0){n.textContent=Ie?Ie.emptyScript:"";for(let v=0;v<u;v++)n.append(m[v],qe()),fe.nextNode(),a.push({type:Ct,index:++s});n.append(m[u],qe())}}}else if(n.nodeType===8)if(n.data===rn)a.push({type:Ct,index:s});else{let u=-1;for(;(u=n.data.indexOf(ie,u+1))!==-1;)a.push({type:Is,index:s}),u+=ie.length-1}s++}g==null||g({kind:"template prep",template:this,clonableTemplate:this.el,parts:this.parts,strings:e})}static createElement(e,t){const i=ye.createElement("template");return i.innerHTML=e,i}}function Oe(o,e,t=o,i){var n,s,r,l;if(e===be)return e;let a=i!==void 0?(n=t.__directives)===null||n===void 0?void 0:n[i]:t.__directive;const d=We(e)?void 0:e._$litDirective$;return(a==null?void 0:a.constructor)!==d&&((s=a==null?void 0:a._$notifyDirectiveConnectionChanged)===null||s===void 0||s.call(a,!1),d===void 0?a=void 0:(a=new d(o),a._$initialize(o,t,i)),i!==void 0?((r=(l=t).__directives)!==null&&r!==void 0?r:l.__directives=[])[i]=a:t.__directive=a),a!==void 0&&(e=Oe(o,a._$resolve(o,e.values),a,i)),e}class Ls{constructor(e,t){this._$parts=[],this._$disconnectableChildren=void 0,this._$template=e,this._$parent=t}get parentNode(){return this._$parent.parentNode}get _$isConnected(){return this._$parent._$isConnected}_clone(e){var t;const{el:{content:i},parts:n}=this._$template,s=((t=e==null?void 0:e.creationScope)!==null&&t!==void 0?t:ye).importNode(i,!0);fe.currentNode=s;let r=fe.nextNode(),l=0,a=0,d=n[0];for(;d!==void 0;){if(l===d.index){let c;d.type===Ct?c=new et(r,r.nextSibling,this,e):d.type===Po?c=new d.ctor(r,d.name,d.strings,this,e):d.type===Ao&&(c=new Us(r,this,e)),this._$parts.push(c),d=n[++a]}l!==(d==null?void 0:d.index)&&(r=fe.nextNode(),l++)}return fe.currentNode=ye,s}_update(e){let t=0;for(const i of this._$parts)i!==void 0&&(g==null||g({kind:"set part",part:i,value:e[t],valueIndex:t,values:e,templateInstance:this}),i.strings!==void 0?(i._$setValue(e,i,t),t+=i.strings.length-2):i._$setValue(e[t])),t++}}class et{constructor(e,t,i,n){var s;this.type=Ct,this._$committedValue=C,this._$disconnectableChildren=void 0,this._$startNode=e,this._$endNode=t,this._$parent=i,this.options=n,this.__isConnected=(s=n==null?void 0:n.isConnected)!==null&&s!==void 0?s:!0,this._textSanitizer=void 0}get _$isConnected(){var e,t;return(t=(e=this._$parent)===null||e===void 0?void 0:e._$isConnected)!==null&&t!==void 0?t:this.__isConnected}get parentNode(){let e=H(this._$startNode).parentNode;const t=this._$parent;return t!==void 0&&(e==null?void 0:e.nodeType)===11&&(e=t.parentNode),e}get startNode(){return this._$startNode}get endNode(){return this._$endNode}_$setValue(e,t=this){var i;if(this.parentNode===null)throw new Error("This `ChildPart` has no `parentNode` and therefore cannot accept a value. This likely means the element containing the part was manipulated in an unsupported way outside of Lit's control such that the part's marker nodes were ejected from DOM. For example, setting the element's `innerHTML` or `textContent` can do this.");if(e=Oe(this,e,t),We(e))e===C||e==null||e===""?(this._$committedValue!==C&&(g==null||g({kind:"commit nothing to child",start:this._$startNode,end:this._$endNode,parent:this._$parent,options:this.options}),this._$clear()),this._$committedValue=C):e!==this._$committedValue&&e!==be&&this._commitText(e);else if(e._$litType$!==void 0)this._commitTemplateResult(e);else if(e.nodeType!==void 0){if(((i=this.options)===null||i===void 0?void 0:i.host)===e){this._commitText("[probable mistake: rendered a template's host in itself (commonly caused by writing ${this} in a template]"),console.warn("Attempted to render the template host",e,"inside itself. This is almost always a mistake, and in dev mode ","we render some warning text. In production however, we'll ","render it, which will usually result in an error, and sometimes ","in the element disappearing from the DOM.");return}this._commitNode(e)}else Ss(e)?this._commitIterable(e):this._commitText(e)}_insert(e){return H(H(this._$startNode).parentNode).insertBefore(e,this._$endNode)}_commitNode(e){var t;if(this._$committedValue!==e){if(this._$clear(),_e!==Ot){const i=(t=this._$startNode.parentNode)===null||t===void 0?void 0:t.nodeName;if(i==="STYLE"||i==="SCRIPT"){let n="Forbidden";throw i==="STYLE"?n="Lit does not support binding inside style nodes. This is a security risk, as style injection attacks can exfiltrate data and spoof UIs. Consider instead using css`...` literals to compose styles, and make do dynamic styling with css custom properties, ::parts, <slot>s, and by mutating the DOM rather than stylesheets.":n="Lit does not support binding inside script nodes. This is a security risk, as it could allow arbitrary code execution.",new Error(n)}}g==null||g({kind:"commit node",start:this._$startNode,parent:this._$parent,value:e,options:this.options}),this._$committedValue=this._insert(e)}}_commitText(e){if(this._$committedValue!==C&&We(this._$committedValue)){const t=H(this._$startNode).nextSibling;this._textSanitizer===void 0&&(this._textSanitizer=So(t,"data","property")),e=this._textSanitizer(e),g==null||g({kind:"commit text",node:t,value:e,options:this.options}),t.data=e}else{const t=ye.createTextNode("");this._commitNode(t),this._textSanitizer===void 0&&(this._textSanitizer=So(t,"data","property")),e=this._textSanitizer(e),g==null||g({kind:"commit text",node:t,value:e,options:this.options}),t.data=e}this._$committedValue=e}_commitTemplateResult(e){var t;const{values:i,["_$litType$"]:n}=e,s=typeof n=="number"?this._$getTemplate(e):(n.el===void 0&&(n.el=Ge.createElement(cn(n.h,n.h[0]),this.options)),n);if(((t=this._$committedValue)===null||t===void 0?void 0:t._$template)===s)g==null||g({kind:"template updating",template:s,instance:this._$committedValue,parts:this._$committedValue._$parts,options:this.options,values:i}),this._$committedValue._update(i);else{const r=new Ls(s,this),l=r._clone(this.options);g==null||g({kind:"template instantiated",template:s,instance:r,parts:r._$parts,options:this.options,fragment:l,values:i}),r._update(i),g==null||g({kind:"template instantiated and updated",template:s,instance:r,parts:r._$parts,options:this.options,fragment:l,values:i}),this._commitNode(l),this._$committedValue=r}}_$getTemplate(e){let t=bi.get(e.strings);return t===void 0&&bi.set(e.strings,t=new Ge(e)),t}_commitIterable(e){an(this._$committedValue)||(this._$committedValue=[],this._$clear());const t=this._$committedValue;let i=0,n;for(const s of e)i===t.length?t.push(n=new et(this._insert(qe()),this._insert(qe()),this,this.options)):n=t[i],n._$setValue(s),i++;i<t.length&&(this._$clear(n&&H(n._$endNode).nextSibling,i),t.length=i)}_$clear(e=H(this._$startNode).nextSibling,t){var i;for((i=this._$notifyConnectionChanged)===null||i===void 0||i.call(this,!1,!0,t);e&&e!==this._$endNode;){const n=H(e).nextSibling;H(e).remove(),e=n}}setConnected(e){var t;if(this._$parent===void 0)this.__isConnected=e,(t=this._$notifyConnectionChanged)===null||t===void 0||t.call(this,e);else throw new Error("part.setConnected() may only be called on a RootPart returned from render().")}}class Lt{constructor(e,t,i,n,s){this.type=Po,this._$committedValue=C,this._$disconnectableChildren=void 0,this.element=e,this.name=t,this._$parent=n,this.options=s,i.length>2||i[0]!==""||i[1]!==""?(this._$committedValue=new Array(i.length-1).fill(new String),this.strings=i):this._$committedValue=C,this._sanitizer=void 0}get tagName(){return this.element.tagName}get _$isConnected(){return this._$parent._$isConnected}_$setValue(e,t=this,i,n){const s=this.strings;let r=!1;if(s===void 0)e=Oe(this,e,t,0),r=!We(e)||e!==this._$committedValue&&e!==be,r&&(this._$committedValue=e);else{const l=e;e=s[0];let a,d;for(a=0;a<s.length-1;a++)d=Oe(this,l[i+a],t,a),d===be&&(d=this._$committedValue[a]),r||(r=!We(d)||d!==this._$committedValue[a]),d===C?e=C:e!==C&&(e+=(d??"")+s[a+1]),this._$committedValue[a]=d}r&&!n&&this._commitValue(e)}_commitValue(e){e===C?H(this.element).removeAttribute(this.name):(this._sanitizer===void 0&&(this._sanitizer=_e(this.element,this.name,"attribute")),e=this._sanitizer(e??""),g==null||g({kind:"commit attribute",element:this.element,name:this.name,value:e,options:this.options}),H(this.element).setAttribute(this.name,e??""))}}class Ms extends Lt{constructor(){super(...arguments),this.type=Ps}_commitValue(e){this._sanitizer===void 0&&(this._sanitizer=_e(this.element,this.name,"property")),e=this._sanitizer(e),g==null||g({kind:"commit property",element:this.element,name:this.name,value:e,options:this.options}),this.element[this.name]=e===C?void 0:e}}const Vs=Ie?Ie.emptyScript:"";class Ds extends Lt{constructor(){super(...arguments),this.type=As}_commitValue(e){g==null||g({kind:"commit boolean attribute",element:this.element,name:this.name,value:!!(e&&e!==C),options:this.options}),e&&e!==C?H(this.element).setAttribute(this.name,Vs):H(this.element).removeAttribute(this.name)}}class zs extends Lt{constructor(e,t,i,n,s){if(super(e,t,i,n,s),this.type=Rs,this.strings!==void 0)throw new Error(`A \`<${e.localName}>\` has a \`@${t}=...\` listener with invalid content. Event listeners in templates must have exactly one expression and no surrounding text.`)}_$setValue(e,t=this){var i;if(e=(i=Oe(this,e,t,0))!==null&&i!==void 0?i:C,e===be)return;const n=this._$committedValue,s=e===C&&n!==C||e.capture!==n.capture||e.once!==n.once||e.passive!==n.passive,r=e!==C&&(n===C||s);g==null||g({kind:"commit event listener",element:this.element,name:this.name,value:e,options:this.options,removeListener:s,addListener:r,oldListener:n}),s&&this.element.removeEventListener(this.name,this,n),r&&this.element.addEventListener(this.name,this,e),this._$committedValue=e}handleEvent(e){var t,i;typeof this._$committedValue=="function"?this._$committedValue.call((i=(t=this.options)===null||t===void 0?void 0:t.host)!==null&&i!==void 0?i:this.element,e):this._$committedValue.handleEvent(e)}}class Us{constructor(e,t,i){this.element=e,this.type=Ao,this._$disconnectableChildren=void 0,this._$parent=t,this.options=i}get _$isConnected(){return this._$parent._$isConnected}_$setValue(e){g==null||g({kind:"commit to element binding",element:this.element,value:e,options:this.options}),Oe(this,e)}}const no=U.litHtmlPolyfillSupportDevMode;no==null||no(Ge,et);((Zt=U.litHtmlVersions)!==null&&Zt!==void 0?Zt:U.litHtmlVersions=[]).push("2.8.0");U.litHtmlVersions.length>1&&St("multiple-versions","Multiple versions of Lit loaded. Loading multiple versions is not recommended.");const Ae=(o,e,t)=>{var i,n;if(e==null)throw new TypeError(`The container to render into may not be ${e}`);const s=ys++,r=(i=t==null?void 0:t.renderBefore)!==null&&i!==void 0?i:e;let l=r._$litPart$;if(g==null||g({kind:"begin render",id:s,value:o,container:e,options:t,part:l}),l===void 0){const a=(n=t==null?void 0:t.renderBefore)!==null&&n!==void 0?n:null;r._$litPart$=l=new et(e.insertBefore(qe(),a),a,void 0,t??{})}return l._$setValue(o),g==null||g({kind:"end render",id:s,value:o,container:e,options:t,part:l}),l};Ae.setSanitizer=_s,Ae.createSanitizer=So,Ae._testOnlyClearSanitizerFactoryDoNotCallOrElse=ws;/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 ...
 */const hn=Symbol.for(""),tr=o=>{if((o==null?void 0:o.r)===hn)return o==null?void 0:o._$litStatic$},or=o=>{if(o._$litStatic$!==void 0)return o._$litStatic$;throw new Error(`Value passed to 'literal' function must be a 'literal' result: ${o}. Use 'unsafeStatic' to pass non-literal values, but
            take care to ensure page security.`)},ct=(o,...e)=>({_$litStatic$:e.reduce((t,i,n)=>t+or(i)+o[n+1],o[0]),r:hn}),wi=new Map,ir=o=>(e,...t)=>{const i=t.length;let n,s;const r=[],l=[];let a=0,d=!1,c;for(;a<i;){for(c=e[a];a<i&&(s=t[a],(n=tr(s))!==void 0);)c+=n+e[++a],d=!0;a!==i&&l.push(s),r.push(c),a++}if(a===i&&r.push(e[i]),d){const m=r.join("$$lit$$");e=wi.get(m),e===void 0&&(r.raw=r,wi.set(m,e=r)),t=l}return o(e,...t)},nr=ir(f),sr="modulepreload",rr=function(o){return"/"+o},Ei={},E=function(o,e,t){if(!e||e.length===0)return o();const i=document.getElementsByTagName("link");return Promise.all(e.map(n=>{if(n=rr(n),n in Ei)return;Ei[n]=!0;const s=n.endsWith(".css"),r=s?'[rel="stylesheet"]':"";if(t)for(let a=i.length-1;a>=0;a--){const d=i[a];if(d.href===n&&(!s||d.rel==="stylesheet"))return}else if(document.querySelector(`link[href="${n}"]${r}`))return;const l=document.createElement("link");if(l.rel=s?"stylesheet":sr,s||(l.as="script",l.crossOrigin=""),l.href=n,document.head.appendChild(l),s)return new Promise((a,d)=>{l.addEventListener("load",a),l.addEventListener("error",()=>d(new Error(`Unable to preload CSS for ${n}`)))})})).then(()=>o()).catch(n=>{const s=new Event("vite:preloadError",{cancelable:!0});if(s.payload=n,window.dispatchEvent(s),!s.defaultPrevented)throw n})};function ar(o){var e;const t=[];for(;o&&o.parentNode;){const i=lr(o);if(i.nodeId!==-1){if((e=i.element)!=null&&e.tagName.startsWith("FLOW-CONTAINER-"))break;t.push(i)}o=o.parentElement?o.parentElement:o.parentNode.host}return t.reverse()}function lr(o){const e=window.Vaadin;if(e&&e.Flow){const{clients:t}=e.Flow,i=Object.keys(t);for(const n of i){const s=t[n];if(s.getNodeId){const r=s.getNodeId(o);if(r>=0)return{nodeId:r,uiId:s.getUIId(),element:o}}}}return{nodeId:-1,uiId:-1,element:void 0}}function dr(o,e){if(o.contains(e))return!0;let t=e;const i=e.ownerDocument;for(;t&&t!==i&&t!==o;)t=t.parentNode||(t instanceof ShadowRoot?t.host:null);return t===o}const cr=(o,e)=>{const t=o[e];return t?typeof t=="function"?t():Promise.resolve(t):new Promise((i,n)=>{(typeof queueMicrotask=="function"?queueMicrotask:setTimeout)(n.bind(null,new Error("Unknown variable dynamic import: "+e)))})};var P=(o=>(o.text="text",o.checkbox="checkbox",o.range="range",o.color="color",o))(P||{});const J={lumoSize:["--lumo-size-xs","--lumo-size-s","--lumo-size-m","--lumo-size-l","--lumo-size-xl"],lumoSpace:["--lumo-space-xs","--lumo-space-s","--lumo-space-m","--lumo-space-l","--lumo-space-xl"],lumoBorderRadius:["0","--lumo-border-radius-m","--lumo-border-radius-l"],lumoFontSize:["--lumo-font-size-xxs","--lumo-font-size-xs","--lumo-font-size-s","--lumo-font-size-m","--lumo-font-size-l","--lumo-font-size-xl","--lumo-font-size-xxl","--lumo-font-size-xxxl"],lumoTextColor:["--lumo-header-text-color","--lumo-body-text-color","--lumo-secondary-text-color","--lumo-tertiary-text-color","--lumo-disabled-text-color","--lumo-primary-text-color","--lumo-error-text-color","--lumo-success-text-color"],basicBorderSize:["0px","1px","2px","3px"]},hr=Object.freeze(Object.defineProperty({__proto__:null,presets:J},Symbol.toStringTag,{value:"Module"})),je={textColor:{propertyName:"color",displayName:"Text color",editorType:P.color,presets:J.lumoTextColor},fontSize:{propertyName:"font-size",displayName:"Font size",editorType:P.range,presets:J.lumoFontSize,icon:"font"},fontWeight:{propertyName:"font-weight",displayName:"Bold",editorType:P.checkbox,checkedValue:"bold"},fontStyle:{propertyName:"font-style",displayName:"Italic",editorType:P.checkbox,checkedValue:"italic"}},Ne={backgroundColor:{propertyName:"background-color",displayName:"Background color",editorType:P.color},borderColor:{propertyName:"border-color",displayName:"Border color",editorType:P.color},borderWidth:{propertyName:"border-width",displayName:"Border width",editorType:P.range,presets:J.basicBorderSize,icon:"square"},borderRadius:{propertyName:"border-radius",displayName:"Border radius",editorType:P.range,presets:J.lumoBorderRadius,icon:"square"},padding:{propertyName:"padding",displayName:"Padding",editorType:P.range,presets:J.lumoSpace,icon:"square"},gap:{propertyName:"gap",displayName:"Spacing",editorType:P.range,presets:J.lumoSpace,icon:"square"}},ur={height:{propertyName:"height",displayName:"Size",editorType:P.range,presets:J.lumoSize,icon:"square"},paddingInline:{propertyName:"padding-inline",displayName:"Padding",editorType:P.range,presets:J.lumoSpace,icon:"square"}},pr={iconColor:{propertyName:"color",displayName:"Icon color",editorType:P.color,presets:J.lumoTextColor},iconSize:{propertyName:"font-size",displayName:"Icon size",editorType:P.range,presets:J.lumoFontSize,icon:"font"}},mr=Object.freeze(Object.defineProperty({__proto__:null,fieldProperties:ur,iconProperties:pr,shapeProperties:Ne,textProperties:je},Symbol.toStringTag,{value:"Module"}));function un(o){const e=o.charAt(0).toUpperCase()+o.slice(1);return{tagName:o,displayName:e,elements:[{selector:o,displayName:"Element",properties:[Ne.backgroundColor,Ne.borderColor,Ne.borderWidth,Ne.borderRadius,Ne.padding,je.textColor,je.fontSize,je.fontWeight,je.fontStyle]}]}}const vr=Object.freeze(Object.defineProperty({__proto__:null,createGenericMetadata:un},Symbol.toStringTag,{value:"Module"})),fr=o=>cr(Object.assign({"./components/defaults.ts":()=>E(()=>Promise.resolve().then(()=>mr),void 0),"./components/generic.ts":()=>E(()=>Promise.resolve().then(()=>vr),void 0),"./components/presets.ts":()=>E(()=>Promise.resolve().then(()=>hr),void 0),"./components/vaadin-app-layout.ts":()=>E(()=>S(()=>import("./vaadin-app-layout-37492a04-65fa31be.js"),[],import.meta.url),[]),"./components/vaadin-avatar.ts":()=>E(()=>S(()=>import("./vaadin-avatar-7047be31-913f1e9c.js"),[],import.meta.url),[]),"./components/vaadin-big-decimal-field.ts":()=>E(()=>S(()=>import("./vaadin-big-decimal-field-b42c1de1-404f7f3b.js"),["./vaadin-big-decimal-field-b42c1de1-404f7f3b.js","./vaadin-text-field-e82c445d-00538e79.js"],import.meta.url),["assets/vaadin-big-decimal-field-b42c1de1.js","assets/vaadin-text-field-e82c445d.js"]),"./components/vaadin-button.ts":()=>E(()=>S(()=>import("./vaadin-button-79ad9d5f-5849d4c7.js"),[],import.meta.url),[]),"./components/vaadin-checkbox-group.ts":()=>E(()=>S(()=>import("./vaadin-checkbox-group-a9a9e85d-53a266e6.js"),["./vaadin-checkbox-group-a9a9e85d-53a266e6.js","./vaadin-text-field-e82c445d-00538e79.js","./vaadin-checkbox-13797fc9-07267c29.js"],import.meta.url),["assets/vaadin-checkbox-group-a9a9e85d.js","assets/vaadin-text-field-e82c445d.js","assets/vaadin-checkbox-13797fc9.js"]),"./components/vaadin-checkbox.ts":()=>E(()=>S(()=>import("./vaadin-checkbox-13797fc9-07267c29.js"),[],import.meta.url),[]),"./components/vaadin-combo-box.ts":()=>E(()=>S(()=>import("./vaadin-combo-box-9046f78f-604b241f.js"),["./vaadin-combo-box-9046f78f-604b241f.js","./vaadin-text-field-e82c445d-00538e79.js"],import.meta.url),["assets/vaadin-combo-box-9046f78f.js","assets/vaadin-text-field-e82c445d.js"]),"./components/vaadin-email-field.ts":()=>E(()=>S(()=>import("./vaadin-email-field-da851bcb-c6bdf47e.js"),["./vaadin-email-field-da851bcb-c6bdf47e.js","./vaadin-text-field-e82c445d-00538e79.js"],import.meta.url),["assets/vaadin-email-field-da851bcb.js","assets/vaadin-text-field-e82c445d.js"]),"./components/vaadin-horizontal-layout.ts":()=>E(()=>S(()=>import("./vaadin-horizontal-layout-f7b1ab51-5796a46a.js"),[],import.meta.url),[]),"./components/vaadin-integer-field.ts":()=>E(()=>S(()=>import("./vaadin-integer-field-6e2954cf-0fc702b1.js"),["./vaadin-integer-field-6e2954cf-0fc702b1.js","./vaadin-text-field-e82c445d-00538e79.js"],import.meta.url),["assets/vaadin-integer-field-6e2954cf.js","assets/vaadin-text-field-e82c445d.js"]),"./components/vaadin-menu-bar.ts":()=>E(()=>S(()=>import("./vaadin-menu-bar-be33385c-6aa03ec7.js"),[],import.meta.url),[]),"./components/vaadin-number-field.ts":()=>E(()=>S(()=>import("./vaadin-number-field-31df11f5-a002dc75.js"),["./vaadin-number-field-31df11f5-a002dc75.js","./vaadin-text-field-e82c445d-00538e79.js"],import.meta.url),["assets/vaadin-number-field-31df11f5.js","assets/vaadin-text-field-e82c445d.js"]),"./components/vaadin-password-field.ts":()=>E(()=>S(()=>import("./vaadin-password-field-49ffb113-ab74f6d9.js"),["./vaadin-password-field-49ffb113-ab74f6d9.js","./vaadin-text-field-e82c445d-00538e79.js"],import.meta.url),["assets/vaadin-password-field-49ffb113.js","assets/vaadin-text-field-e82c445d.js"]),"./components/vaadin-progress-bar.ts":()=>E(()=>S(()=>import("./vaadin-progress-bar-3b53bb70-4494b9e9.js"),[],import.meta.url),[]),"./components/vaadin-radio-group.ts":()=>E(()=>S(()=>import("./vaadin-radio-group-4a6e2cf4-5b28f537.js"),["./vaadin-radio-group-4a6e2cf4-5b28f537.js","./vaadin-text-field-e82c445d-00538e79.js"],import.meta.url),["assets/vaadin-radio-group-4a6e2cf4.js","assets/vaadin-text-field-e82c445d.js"]),"./components/vaadin-scroller.ts":()=>E(()=>S(()=>import("./vaadin-scroller-35e68818-0cdbc796.js"),[],import.meta.url),[]),"./components/vaadin-select.ts":()=>E(()=>S(()=>import("./vaadin-select-5d6ab45b-92dfd6da.js"),["./vaadin-select-5d6ab45b-92dfd6da.js","./vaadin-text-field-e82c445d-00538e79.js"],import.meta.url),["assets/vaadin-select-5d6ab45b.js","assets/vaadin-text-field-e82c445d.js"]),"./components/vaadin-split-layout.ts":()=>E(()=>S(()=>import("./vaadin-split-layout-10c9713b-b6e40184.js"),[],import.meta.url),[]),"./components/vaadin-text-area.ts":()=>E(()=>S(()=>import("./vaadin-text-area-41c5f60c-657ee027.js"),["./vaadin-text-area-41c5f60c-657ee027.js","./vaadin-text-field-e82c445d-00538e79.js"],import.meta.url),["assets/vaadin-text-area-41c5f60c.js","assets/vaadin-text-field-e82c445d.js"]),"./components/vaadin-text-field.ts":()=>E(()=>S(()=>import("./vaadin-text-field-e82c445d-00538e79.js"),[],import.meta.url),[]),"./components/vaadin-time-picker.ts":()=>E(()=>S(()=>import("./vaadin-time-picker-2fa5314f-5b8aebf1.js"),["./vaadin-time-picker-2fa5314f-5b8aebf1.js","./vaadin-text-field-e82c445d-00538e79.js"],import.meta.url),["assets/vaadin-time-picker-2fa5314f.js","assets/vaadin-text-field-e82c445d.js"]),"./components/vaadin-vertical-layout.ts":()=>E(()=>S(()=>import("./vaadin-vertical-layout-ff73c403-dd52e82d.js"),[],import.meta.url),[]),"./components/vaadin-virtual-list.ts":()=>E(()=>S(()=>import("./vaadin-virtual-list-62d4499a-329489f9.js"),[],import.meta.url),[])}),`./components/${o}.ts`);class gr{constructor(e=fr){this.loader=e,this.metadata={}}async getMetadata(e){var t;const i=(t=e.element)==null?void 0:t.localName;if(!i)return null;if(!i.startsWith("vaadin-"))return un(i);let n=this.metadata[i];if(n)return n;try{n=(await this.loader(i)).default,this.metadata[i]=n}catch{console.warn(`Failed to load metadata for component: ${i}`)}return n||null}}const yr=new gr,yt={crosshair:Te`<svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
...
`,xi="__vaadin-theme-editor-measure-element",Ci=/((::before)|(::after))$/,ki=/::part\(([\w\d_-]+)\)$/;Oo(k`
...
`);let Xe=class extends A{constructor(){super(...arguments),this.value=z.local}static get styles(){return k`
      vaadin-select {
        --lumo-primary-color-50pct: rgba(255, 255, 255, 0.5);
        width: 100px;
      }
...
`;let Qe=class extends A{constructor(){super(...arguments),this.commitValue=!1}static get styles(){return[fn,k`
        #toggle {
          display: block;
        }
    ...
    `];It=wa([F("vaadin-dev-tools-shim")],It);const gn=k`
  .popup {
    width: auto;
    position: fixed;
...
`;var Ea=Object.defineProperty,Sa=Object.getOwnPropertyDescriptor,ot=(o,e,t,i)=>{for(var n=i>1?void 0:i?Sa(e,t):e,s=o.length-1,r;s>=0;s--)(r=o[s])&&(n=(i?r(e,t,n):r(n))||n);return i&&n&&Ea(e,t,n),n};let he=class extends A{constructor(){super(...arguments),this.active=!1,this.components=[],this.selected=0}connectedCallback(){super.connectedCallback();const o=new CSSStyleSheet;o.replaceSync(`
...
`);let ne=class extends A{constructor(){super(...arguments),this.expanded=!1,this.themeEditorState=Ye.enabled,this.context=null,this.baseTheme=null,this.editedTheme=null,this.effectiveTheme=null}static get styles(){return k`
      :host {
    ...
    `}render(){return f` <div
      ...
      >
        <div class="window-toolbar">
          ${this.tabs.map(e=>f`<button
                class=${Io({tab:!0,active:this.activeTab===e.id,unreadErrors:e.id==="log"&&this.unreadErrors})}
                id="${e.id}"
        ...
        ${this.tabs.map(e=>this.activeTab===e.id?e.render():C)}
      </div>
      ...
      >
        ...
        ></span>
        ${this.splashMessage?f`<span class="status-description">${this.splashMessage}</span></div>`:C}
      ...
      <div>
        ...
        <button
          class="button pick"
          @click=${async()=>{await E(()=>Promise.resolve().then(()=>xa),void 0),this.componentPicker.open({infoTemplate:f`
                <div>
